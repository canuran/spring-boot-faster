...
public class QPermission extends com.querydsl.sql.RelationalPathBase<Permission> {
    ...
    private static final long serialVersionUID = 421343232;
    ...
    public void addMetadata() {
        ...
        addMetadata(permissionId, ColumnMetadata.named("permission_id").withIndex(1).ofType(Types.DECIMAL).withSize(31).notNull());
        ...
        addMetadata(userId, ColumnMetadata.named("user_id").withIndex(2).ofType(Types.DECIMAL).withSize(31).notNull());
    }

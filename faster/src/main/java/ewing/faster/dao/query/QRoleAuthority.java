...
public class QRoleAuthority extends com.querydsl.sql.RelationalPathBase<RoleAuthority> {
    ...
    private static final long serialVersionUID = -603066971;
    ...
    public void addMetadata() {
        addMetadata(authorityId, ColumnMetadata.named("authority_id").withIndex(2).ofType(Types.DECIMAL).withSize(26).notNull());
